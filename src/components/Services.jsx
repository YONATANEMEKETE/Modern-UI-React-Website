      ...
      <div className="container">
        ...
        <div className="relative">
          ...
          >
            ...
            <Generating
              className="absolute left-4 right-4 bottom-4 border lg:w-[40rem] xl:w-[50rem]
          ...
          <div className="relative grid z-1 gap-5 lg:grid-cols-2">
            ...
            {/* the third service about to be built below */}
              ...
              <div className="py-12 px-4 xl:px-8">
                ...
                <ul className="flex items-center justify-between">
                  {brainwaveServicesIcons.map((item, index) => (
                    ...
                    >
                      <div className="flex items-center justify-center w-full h-full bg-n-6 rounded-[1rem]">
                        <img width={24} height={24} alt="icons" src={item} />
                      </div>
                    </li>
                  ))}
                </ul>
